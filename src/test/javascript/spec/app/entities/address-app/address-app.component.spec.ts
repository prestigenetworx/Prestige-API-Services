...
import { AddressAppComponent } from 'app/entities/address-app/address-app.component';
...
describe('Component Tests', () => {
    describe('AddressApp Management Component', () => {
        let comp: AddressAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AddressAppComponent, '')
                .compileComponents();
