...
import { ProductAppComponent } from 'app/entities/product-app/product-app.component';
...
describe('Component Tests', () => {
    describe('ProductApp Management Component', () => {
        let comp: ProductAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProductAppComponent, '')
                .compileComponents();
