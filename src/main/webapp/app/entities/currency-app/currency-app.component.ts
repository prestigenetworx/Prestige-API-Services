...
@Component({
    selector: 'jhi-currency-app',
    templateUrl: './currency-app.component.html'
})
export class CurrencyAppComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.currencyService
            ...
            .subscribe(
                (res: HttpResponse<ICurrencyApp[]>) => this.paginateCurrencies(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/currency-app'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ICurrencyApp) {
        return item.id;
    }
    ...
    private paginateCurrencies(data: ICurrencyApp[], headers: HttpHeaders) {
