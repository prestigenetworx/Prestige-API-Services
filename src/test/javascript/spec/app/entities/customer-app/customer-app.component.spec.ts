...
import { CustomerAppComponent } from 'app/entities/customer-app/customer-app.component';
...
describe('Component Tests', () => {
    describe('CustomerApp Management Component', () => {
        let comp: CustomerAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CustomerAppComponent, '')
                .compileComponents();
