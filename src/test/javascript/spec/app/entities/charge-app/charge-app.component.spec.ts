...
import { ChargeAppComponent } from 'app/entities/charge-app/charge-app.component';
...
describe('Component Tests', () => {
    describe('ChargeApp Management Component', () => {
        let comp: ChargeAppComponent;
        let fixture: ComponentFixture<ChargeAppComponent>;
        let service: ChargeAppService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PrestigeTestModule],
                declarations: [ChargeAppComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ChargeAppComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ChargeAppComponent);
