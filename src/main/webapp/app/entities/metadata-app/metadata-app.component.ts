...
@Component({
    selector: 'jhi-metadata-app',
    templateUrl: './metadata-app.component.html'
})
export class MetadataAppComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.metadataService
            ...
            .subscribe(
                (res: HttpResponse<IMetadataApp[]>) => this.paginateMetadata(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/metadata-app'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IMetadataApp) {
        return item.id;
    }
    ...
    private paginateMetadata(data: IMetadataApp[], headers: HttpHeaders) {
