...
import com.prestige.network.repository.ProductRepository;
...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getAttributes()).isEqualTo(DEFAULT_ATTRIBUTES);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getAttributes()).isEqualTo(UPDATED_ATTRIBUTES);
    }
