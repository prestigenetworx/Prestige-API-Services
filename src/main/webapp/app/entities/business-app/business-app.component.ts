...
export class BusinessAppComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.businessService
            ...
            .subscribe(
                (res: HttpResponse<IBusinessApp[]>) => this.paginateBusinesses(res.body, res.headers),
    ...
    trackId(index: number, item: IBusinessApp) {
        return item.id;
    }
    ...
    private paginateBusinesses(data: IBusinessApp[], headers: HttpHeaders) {
