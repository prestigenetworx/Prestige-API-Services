...
export class CustomerAppComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.customerService
            ...
            .subscribe(
                (res: HttpResponse<ICustomerApp[]>) => this.paginateCustomers(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/customer-app'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ICustomerApp) {
        return item.id;
    }
    ...
    private paginateCustomers(data: ICustomerApp[], headers: HttpHeaders) {
