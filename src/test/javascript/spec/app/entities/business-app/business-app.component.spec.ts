...
import { BusinessAppComponent } from 'app/entities/business-app/business-app.component';
...
describe('Component Tests', () => {
    describe('BusinessApp Management Component', () => {
        let comp: BusinessAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BusinessAppComponent, '')
                .compileComponents();
