...
export class ProductAppComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.productService
            ...
            .subscribe(
                (res: HttpResponse<IProductApp[]>) => this.paginateProducts(res.body, res.headers),
    ...
    trackId(index: number, item: IProductApp) {
        return item.id;
    }
    ...
    private paginateProducts(data: IProductApp[], headers: HttpHeaders) {
