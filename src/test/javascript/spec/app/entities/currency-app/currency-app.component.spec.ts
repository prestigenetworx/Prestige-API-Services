...
import { CurrencyAppComponent } from 'app/entities/currency-app/currency-app.component';
...
describe('Component Tests', () => {
    describe('CurrencyApp Management Component', () => {
        let comp: CurrencyAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CurrencyAppComponent, '')
                .compileComponents();
