...
import { MetadataAppComponent } from 'app/entities/metadata-app/metadata-app.component';
...
describe('Component Tests', () => {
    describe('MetadataApp Management Component', () => {
        let comp: MetadataAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MetadataAppComponent, '')
                .compileComponents();
